          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                <input
                  type="checkbox"
                  checked={formData.agreementTerms && formData.agreementPrivacy && formData.agreementMarketing}
              ...
              <div className="pl-6 space-y-2 border-l-2 border-gray-100">
                ...
                {errors.agreementTerms && <p className="text-red-500 text-xs ml-6">{errors.agreementTerms}</p>}
                ...
                {errors.agreementPrivacy && <p className="text-red-500 text-xs ml-6">{errors.agreementPrivacy}</p>}
