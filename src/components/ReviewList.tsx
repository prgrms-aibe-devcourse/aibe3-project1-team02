...
const mockReviews: Review[] = [
    {
        ...
        rating: 5,
        comment:
            '정말 완벽한 제주도 여행이었습니다! 가이드분도 친절하시고 일정도 알차게 구성되어 있어서 너무 만족스러웠어요. 특히 한라산 등반과 성산일출봉에서의 일출은 평생 잊지 못할 추억이 될 것 같습니다.',
        date: '2024-01-15',
        helpful: 24,
        images: [
    ...
    },
    {
        ...
        rating: 4,
        comment:
            '가족과 함께 다녀왔는데 아이들도 너무 좋아했어요. 숙소도 깨끗하고 음식도 맛있었습니다. 다만 일정이 조금 빡빡한 느낌이 있어서 좀 더 여유롭게 즐길 수 있었으면 좋겠어요.',
        date: '2024-01-10',
        helpful: 18,
    },
    {
        ...
        rating: 5,
        comment:
            '혼자 여행으로 갔는데 정말 좋았습니다. 다른 참가자들과도 금방 친해져서 즐거운 시간을 보냈어요. 제주의 자연을 만끽할 수 있는 완벽한 코스였습니다.',
        date: '2024-01-05',
        helpful: 12,
    },
    {
        ...
        rating: 4,
        comment:
            '부산의 바다를 실컷 즐길 수 있어서 좋았어요. 해운대와 광안리 모두 아름다웠고, 특히 밤에 보는 광안대교가 인상적이었습니다.',
        date: '2024-01-08',
        helpful: 15,
    },
]
...
export default function ReviewList({ productId }: ReviewListProps) {
    ...
    const filteredReviews = productId ? reviews.filter((review) => review.productId === productId) : reviews
        ...
        <div className="max-w-4xl mx-auto px-6 py-8">
            <div className="mb-8">
                <div className="flex items-center justify-between mb-6">
                    <div>
                        <h2 className="text-2xl font-bold text-gray-900 mb-2">리뷰 ({filteredReviews.length}개)</h2>
                ...
                {sortedReviews.map((review) => (
                    <div key={review.id} className="bg-white rounded-lg shadow-sm border p-6">
                        <div className="flex items-start justify-between mb-4">
                            <div className="flex items-center gap-4">
                                <div className="w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center">
                                    <span className="text-blue-600 font-semibold">{review.userName.charAt(0)}</span>
                                </div>
                                <div>
                        ...
                        <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                            ...
                            <button className="text-gray-500 hover:text-gray-700 text-sm cursor-pointer">신고</button>
                        </div>
                    </div>
                ))}
            </div>
