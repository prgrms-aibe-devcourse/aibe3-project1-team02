                ...
                {isMenuOpen && (
                    <div className="md:hidden py-2 space-y-2">
                        ...
                        <div className="border-t pt-2 space-y-2">
                            <Link
                                href="/login"
                                className="block px-3 py-2 text-gray-700 hover:text-blue-600 whitespace-nowrap"
                            >
                                로그인
                            </Link>
                            <Link
                                href="/signup"
                                className="block px-3 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 whitespace-nowrap"
                            >
                                회원가입
                            </Link>
                        </div>
