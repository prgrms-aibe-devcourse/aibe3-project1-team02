        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/destinations" className="text-gray-400 hover:text-white transition-colors cursor-pointer">여행지 찾기</Link></li>
              <li><Link href="/planner" className="text-gray-400 hover:text-white transition-colors cursor-pointer">여행 계획</Link></li>
              <li><Link href="/community" className="text-gray-400 hover:text-white transition-colors cursor-pointer">여행후기</Link></li>
              <li><Link href="/reviews" className="text-gray-400 hover:text-white transition-colors cursor-pointer">리뷰</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/help" className="text-gray-400 hover:text-white transition-colors cursor-pointer">도움말</Link></li>
