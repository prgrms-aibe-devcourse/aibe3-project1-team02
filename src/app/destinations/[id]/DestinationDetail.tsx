...
export default function DestinationDetail({ destinationId }: DestinationDetailProps) {
  ...
  const destinations = {
    '1': {
      ...
      price: '120,000원부터',
      tags: ['자연', '힐링', '해변'],
      description: '한국의 대표적인 휴양지 제주도는 아름다운 자연경관과 독특한 문화로 유명합니다. 한라산, 성산일출봉, 우도 등 다양한 관광명소와 맛있는 향토음식을 즐길 수 있습니다.',
      images: [
      ...
      highlights: [
        { title: '한라산 국립공원', description: '한국 최고봉과 아름다운 등산로' },
        { title: '성산일출봉', description: '세계자연유산 지정 일출 명소' },
        { title: '우도', description: '에메랄드빛 바다의 작은 섬' },
        { title: '제주 올레길', description: '아름다운 해안선을 따라 걷는 길' }
      ],
    ...
    '2': {
      ...
      price: '95,000원부터',
      tags: ['도시', '해변', '문화'],
      description: '한국의 대표적인 항구도시 부산은 아름다운 해변과 다양한 문화, 맛있는 음식으로 유명합니다. 해운대, 감천문화마을, 자갈치시장 등을 즐길 수 있습니다.',
      images: [
    ...
    '3': {
      ...
      price: '380,000원부터',
      tags: ['도시', '쇼핑', '문화'],
      description: '일본의 수도 도쿄는 전통과 현대가 조화롭게 어우러진 매력적인 도시입니다. 아사쿠사, 시부야, 하라주쿠 등 다양한 지역의 독특한 문화를 경험할 수 있습니다.',
      images: [
                      ...
                      <div className="flex items-center gap-1">
                        {[...Array(5)].map((_, i) => (
                          <div key={i} className="w-4 h-4 flex items-center justify-center">
                            <i className={`ri-star-fill text-sm ${i < review.rating ? 'text-yellow-400' : 'text-gray-300'}`}></i>
                          </div>
                        ))}
                      </div>
                    </div>
